    ...
    switch (e.target.id) {
      case editorIds.company_address:
        dispatch({
          ...
          payload: { companyAddress: e.target.value },
        });
        break;
      ...
      case editorIds.hiring_name:
        dispatch({
          type: Actions.CHANGE_COMPANY_PERSON,
          payload: { companyPerson: e.target.value },
        });
        break;
  ...
  return (
    <form action="">
      ...
      <div className="form-group">
        ...
        <input
          onChange={onFieldChange}
          value={state.job_portal}
          type="text"
          id={editorIds.job_portal}
        />
      </div>
      <div className="form-group">
      ...
      <ul>
        ...
        <li>
          Add {"<company_message>"} where you want to add company specific
          message
        </li>
      </ul>
      <div className="form-group">
        <label htmlFor={editorIds.company_message}>
          company specific information/ or place to fill in{" "}
          {"<company_message>"}
        </label>
        <textarea
          onChange={onFieldChange}
          value={state.company_message}
          name="intro_para"
          id={editorIds.company_message}
          cols={30}
          rows={10}
        />
      </div>
      ...
      <div className="form-group">
        <label htmlFor={editorIds.para4}>
          Talk about your analytical skills
        </label>
        <textarea
          onChange={onFieldChange}
          value={state.para4}
